...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETED (6) Register MainActivity as a OnSharedPreferenceChangedListener in onCreat
    ...
    // COMPLTED (5) Override onSharedPreferenceChanged to set the preferences flag to true
}