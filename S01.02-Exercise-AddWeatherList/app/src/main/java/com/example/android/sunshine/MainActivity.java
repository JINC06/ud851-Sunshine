...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] fakeWeatherData = {
                "Today, Junuary 29 - Clear - 28°C / 32°C",
                "Tomorrow - Cloudy - 28°C / 32°C"
        };

        // COMPLETED (4) Append each String from the fake weather data array to the TextView

        for (String fakeWeatherDayInfo : fakeWeatherData) {
            mWeatherDisplayTextView.append(fakeWeatherDayInfo + "\n\n\n");
        }
    }
}